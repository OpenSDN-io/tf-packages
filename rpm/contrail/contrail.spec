...
Summary: Fabric Ansible archive
Group:              Applications/System

%description fabric-ansible
Libraries for fabric-ansible which can be run by device-manager

%files fabric-ansible
...
%package docs
Summary: Documentation for OpenSDN
Group: Applications/System

%description docs
OpenSDN is a network virtualization solution that provides an overlay
virtual-network to virtual-machines, containers or network namespaces.

This package contains the documentation for messages generated by OpenSDN
modules/daemons.
